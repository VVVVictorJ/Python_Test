...
class MutilpleDatabaseOperation:
    # url = "mysql+pymysql://bwms:bwms_user@www.zjbaosight.com:3306/bwms?charset=utf8"
    ...
    def test(self, paralist: list):
        ...
        try:
            with self.__engine.connect() as connection:
                connection.execute(insert(self.DCYW0023), paralist)
...
#     tasks = [asyncio.create_task(obj.test(randomValue(a))) for i in range(1)]
#     for task in tasks:
#         await task
#     await task
#     await obj.close()
