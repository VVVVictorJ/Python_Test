...
print('类 Singleton 的 __instance 属性值：', Singleton._SingletonMeta__instance)
...
s2 = Singleton()
print(id(s2))
print('类 Singleton 的 __instance 属性值：', s1._SingletonMeta__instance)
print('类 Singleton 的 __instance 属性值：', s2._SingletonMeta__instance)
